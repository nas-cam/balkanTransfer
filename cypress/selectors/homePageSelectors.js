...
export const DROPDOWN_TO = "//div[@class='MuiBox-root mui-3hg8yt']";
...
export const COMPANY_LINK = 'button:contains("Company")';
...
export const PAGE_HEADER = "span.MuiTypography-root.MuiTypography-h4Medium";
export const DISCOVER_LINK = 'button:contains("Discover")';
...
export const EUR_CURRENCY = 'li[role="option"][data-value="EUR"]';
export const BAM_CURRENCY = 'li[role="option"][data-value="BAM"]';
export const LANGUAGE_DROPDOWN = "/html[1]/body[1]/div[1]/main[1]/header[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/div[1]";
export const ENGLISH_LANGUAGE = 'li[role="option"][data-value="en"]';
export const BOSNIAN_LANGUAGE = 'li[role="option"][data-value="bs"]';